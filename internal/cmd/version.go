...
var CURRENT_VERSION string = "v3.3.0-beta.1"
...
var FrameworkModules = []gothci_cli.FrameworkModule{
	{Path: "github.com/gothicframework/core", Version: "v1.3.0-beta.1"},
	{Path: "github.com/gothicframework/components", Version: "v1.1.0-beta.1"},
	{Path: "github.com/gothicframework/middlewares", Version: "v1.1.0-beta.1"},
}
